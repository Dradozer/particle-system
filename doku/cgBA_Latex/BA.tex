...
CountingSort ist ein paralleler und nicht vergleichsbasierter Algorithmus, dabei erlaubt er uns das Sortieren von 
\cite{counting}
...
\end{figure}
 ...
 Dabei wird wie in Abbildung \ref{img:lable} in Zeile 60 zu sehen die Anzahl der Partikel in einem Grid gespeichtert. Die atomicAdd-Funktion wird dabei durchgeführt und es wird der Wert $grid[temp].particlesInGrid$ um 1 erhöht. 
